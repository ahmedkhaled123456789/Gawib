// src/components/questions/AddQuestion.tsx
...
const AddBostedQuestion: React.FC<Props> = ({ selectedId, onClose }) => {
  ...
  useEffect(() => {
    ...
    // ensure gameOptions loaded (if you want to require it, keep it in deps)
  ...
  // Submit (create or update) — note: dispatch called directly per branch to keep typings safe
  const submitQuestion = async () => {
    ...
    if (selectedId) {
      ...
      dispatch(updateQuestion({ id: selectedId, formData, isActivePage: true }))
        .unwrap()
        .then(() => {
...
export default AddBostedQuestion;

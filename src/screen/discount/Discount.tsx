    ...
    <tr key={product.id}>
      ...
      <td className="px-4 py-2 text-gray-700">
        <Link to={`/productDetails/${product._id}`}>
          <div className="w-32">{product.code}</div>{" "}
        </Link>
      </td>
      <td className="px-4 py-2 text-gray-700">
      ...
      <td className="px-4 py-2 text-gray-700">
        <div className="w-32">{product.ends_at}</div>
      </td>

      <td className="px-4 py-2 text-gray-700">
        <div className="w-32">{product.type ? "عام" : "خاص"}</div>
      </td>
      <td
        className={`px-4 py-2 ${
      ...
      <div className="mx-2">
        ...
        <div className="flex  p-4  bg-white md:flex-row items-center justify-between gap-4 ">
          ...
          <div className="flex items-center gap-2 ">
            <span className="text-[#588A17]   border border-[#085E9C] bg-[#d5d5d5] rounded px-4 py-1 ">
              نشط
            </span>
            <span className="text-[#7e7e7e] border border-[#085E9C] bg-[#d5d5d5] rounded px-4 py-1 ">
              منتهي
            </span>
            <span className="text-[#ff426e] border border-[#085E9C] rounded px-4 py-1 ">
              محذوف
            </span>
          </div>
          <div className="flex items-center space-x-4 space-x-reverse">
            <button
              className="bg-yellow-500 hover:bg-yellow-600 text-[#085E9C] border border-[#085E9C] px-4 py-1 rounded text-sm font-medium transition-colors"

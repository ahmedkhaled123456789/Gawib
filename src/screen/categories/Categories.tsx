...
const CategoriesRow = ({ product,setSelectedImg, index,setShowCatModal }) => {
  ...
  <span>الكل</span>
            ...
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product, index) => (
                <CategoriesRow key={product._id} setSelectedImg={setSelectedImg} product={product}  setShowCatModal={setShowCatModal} index={index} />
              ))
            ) : (
              <tr>

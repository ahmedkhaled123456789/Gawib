    ...
    <div className="w-[60%] p-5 mb-4">
      <div className="bg-white rounded-md p-10 mb-5">
        <form className="flex flex-wrap  gap-5 pt-5">
          <label className="mb-1 text-lg font-bold text-right text-[#085E9C] ">
            الرد على الرسالة
          </label>
          <textarea
            value={message}
            ...
            cols={25}
            rows={10}
            className="w-full rounded resize-none border border-[#085E9C]  p-3 text-sm shadow-md outline-none text-right"
